...
setting = input('where are we')
objective = input('what do you want')
story = f'{hero_name} is the hero of our story, we find our hero in a {setting} making his way to the tower that holds {objective}.'
print(story)